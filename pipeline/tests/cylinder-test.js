/*
 * Unit tests for our cylinder object.
 */
$(function () {
    ...
    test("Cylinder", function () {
        ...
        deepEqual(shape.vertices.length, 72, "Vertices length (res 4)");

        shape = new FrustumCylinder(
            GLSLUtilities, 
            gl, 
            false, 
            { r: 0.0, g: 0.0, b: 0.5 }, 
            res,
            0.5);
        deepEqual(shape.vertices.length, 144, "Vertices length (not filled, res 4)");
        ...
        shape = new FrustumCylinder(
            ...
            res,
            0.5);
        deepEqual(shape.vertices.length, 360, "Vertices length (res 20)");
        ...
        shape = new FrustumCylinder(
            ...
            res,
            0.5);
        deepEqual(shape.vertices.length, 720, "Vertices length (not filled, res 20)");
        ...
        shape = new FrustumCylinder(
            ...
            res,
            0.5);
        deepEqual(shape.vertices.length, 720, "Vertices length (res 40)");
        ...
        shape = new FrustumCylinder(
            ...
            res,
            0.5);
        deepEqual(shape.vertices.length, 1440, "Vertices length (not filled, res 40)");
